...
- **Mobile controls:** Date selection, preferences, and methodology use full-size pill controls; preferences open in a centered modal so the panel never clips off-screen
